...
def create_model_info(architecture):
  ...
  if architecture == 'inception_v3':
    ...
    if (size_string != '224' and size_string != '192' and
      ...
      tf.logging.error(
          """The Mobilenet input size should be '224', '192', '160', or '128',but found '%s' for architecture '%s'""",size_string, architecture)
      return None
    if len(parts) == 3:
      is_quantized = False
    else:
...
architecture = 'inception_v3'   #'mobilenet_1.0_224' #
