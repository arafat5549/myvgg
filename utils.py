...
def print_prob(prob, file_path,fore='green'):
    ...
    # Get top1 label
    top1 = synset[pred[0]]
    printcolor(("Top1: ", top1, prob[pred[0]]),mode = 'bold',fore = fore)
    #print(tcolor.UseStyle(("Top1: ", top1, prob[pred[0]]),mode = 'bold',fore = forecolor))
