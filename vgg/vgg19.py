...
class Vgg19:
    def __init__(self, vgg19_npy_path=None):
        ...
        print("npy file [",vgg19_npy_path,"] loaded")
    ...
    def build(self, rgb,xmode=0):
        ...
        self.conv3_4 = self.conv_layer(self.conv3_3, layers["conv3_4"])
        self.pool3 = self.max_pool(self.conv3_4, layers['pool3'])
        ...
        self.conv4_4 = self.conv_layer(self.conv4_3, layers["conv4_4"])
        self.pool4 = self.max_pool(self.conv4_4, layers['pool4'])
        ...
        self.conv5_4 = self.conv_layer(self.conv5_3, layers["conv5_4"])
        self.pool5 = self.max_pool(self.conv5_4, layers['pool5'])
