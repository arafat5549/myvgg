...
parser.add_argument('--num_epochs1', default=EPOCH, type=int)
parser.add_argument('--num_epochs2', default=EPOCH, type=int)
...
def main(args):
    ...
    with graph.as_default():
        ...
        variables_to_restore = tf.contrib.framework.get_variables_to_restore(exclude=[VGG_TYPE+'/fc8'])
...
def save_npy(var_dict, sess, npy_path=TRAIN_MODEL_NAME+".npy"):
